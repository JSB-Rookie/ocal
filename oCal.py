...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.currentDateLE.setPlaceholderText('Press Return')
        self.currentDateLE.returnPressed.connect(self.theNowDate)
    ...
    def theNowDate(self):
        now = datetime.now()
        self.currentDateLE.setText(now.strftime('%d %b %Y'))
